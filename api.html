...
$productId    = 44876;   // id товара в системе
$productPrice = 890;   // цена товара при создании заказа
$thankUrl     = 'https://ulze.github.io/pizhama/success/index.html'; // урл вашей страницы спасибо
...
$streamId      = 44876; // id потока в системе (заказ будет привязываться к конретному потоку. полезно при настройке постбека)
